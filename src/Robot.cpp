...
void Robot::TeleopInit() {
	...
	//myArcade = new RobotDrive(RobotMap::driveTraindBaseL1, RobotMap::driveTraindBaseL2, RobotMap::driveTraindBaseR1, RobotMap::driveTraindBaseR2);
...
void Robot::TeleopPeriodic() {
	...
	//myArcade->ArcadeDrive(Robot::oi->getDriveController(), 1, Robot::oi->getDriveController(), 2, false);
}
