...
void Robot::RobotInit() {
    ...
    // auto things
    oneGearAutoPin = (new DigitalInput(0));
    tenBallAutoPin = (new DigitalInput(6));
    encoderGearAutoPin = (new DigitalInput(7));
    driveForwardAutoDeadReckoningPin = (new DigitalInput(8));
    driveForwardEncoderPin = (new DigitalInput(AUTO_DRIVE_FORWARD_ENC_PIN));
