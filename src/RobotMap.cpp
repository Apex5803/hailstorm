...
void RobotMap::init() {
    ...
    driveTraindBaseL1.reset(new CANTalon (DRIVE_SPEED_LEFT_1));
    driveTraindBaseL1->SetInverted(true);
    lw->AddActuator("DriveTrain", "dBaseL1", std::static_pointer_cast<CANTalon>(driveTraindBaseL1));

    driveTraindBaseL2.reset(new CANTalon(DRIVE_SPEED_LEFT_2));
    ...
    gearergearRoller.reset(new CANTalon(GEAR_ROLLER));
    lw->AddActuator("Gearer", "gearRoller", std::static_pointer_cast<CANTalon>(gearergearRoller));
...
*/
    ...
    climber.reset(new CANTalon(C_MOTOR));
    climber->SetInverted(false);
    lw->AddActuator("Climber", "climber", std::static_pointer_cast<CANTalon>(climber));
