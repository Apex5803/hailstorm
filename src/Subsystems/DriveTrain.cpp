...
DriveTrain::DriveTrain() : PIDSubsystem("DriveTrain", 1.0, 0.0, 0.0) {
    ...
    dBaseL = RobotMap::driveTraindBaseL;
    dBaseR = RobotMap::driveTraindBaseR;
...
void DriveTrain::UsePIDOutput(double output) {
    ...
    dBaseL->PIDWrite(output);
    dBaseR->PIDWrite(output);
...
void DriveTrain :: MyDrive(float leftSpeed,float rightSpeed){
	drive->TankDrive(leftSpeed,rightSpeed);

}

void DriveTrain :: MyDrive(Joystick* left, Joystick* right){
