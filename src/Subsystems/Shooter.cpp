...
Shooter::Shooter() : PIDSubsystem("Shooter", 1.0, 0.0, 0.0) {
    ...
    shooterEncoderPrimary = RobotMap::shootershooterEncoderPrimary;
    shooterEncoderBooster = RobotMap::shootershooterEncoderBooster;
...
double Shooter::ReturnPIDInput() {
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SOURCE
        return shooterEncoderPrimary->PIDGet();
...
void Shooter::UsePIDOutput(double output) {
    ...
    shooterWheelPrimary->PIDWrite(output);
...
void Shooter::ShootManual(){
	shooterWheelPrimary->Set(.75);
	shooterWheelBooster->Set(.75);
}


//turns off shooter
void Shooter::Off(){
	shooterWheelPrimary->Set(.0);
	shooterWheelBooster->Set(.0);
}
